...
<section
	class="px-4 flex bottom-0 h-18 flex-row w-screen z-50 justify-center gap-4 fixed md:right-0 md:h-screen md:w-32 md:py-8 bg-lightblue md:flex-col md:items-center md:justify-between md:rounded-l-3xl"
>
