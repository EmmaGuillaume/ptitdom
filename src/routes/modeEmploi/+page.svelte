...
<svelte:head>
	...
	<link rel="canonical" href="https://ptitdom.vercel.app/modeEmploi" />
...
<section
	class="w-screen h-screen relative flex flex-col justify-start items-start px-20 py-8 md:py-16"
>
