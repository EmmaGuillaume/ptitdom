...
<div class="flex mr-20">
	...
	<div class="ml-48">
		<p>
			...
			En effet toute reproduction ou utilisation est strictement interdite sans accord au préalable
			de l'éditeur.
			<br /><br />
...
<div class="flex mr-20">
	...
	<div class="ml-48">
		<p>
			...
			et le traitement d’informations personnelles s’effectuent dans le respect de la vie privée,
			lors de l’inscription sur le site, vous nous autorisez à collecter les données suivantes :
		</p>
		<br />
		<ul class="list-disc ml-10">
